            ...
            <div class="col-lg-8 col-xl-6">
              <div class="card rounded-3 mb-3" style="background-color: beige;" >
                ...
                <div class="card-body p-4 p-md-5">
                  <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2  text-center"><?php echo e(__('ui.nav-register')); ?></h3>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-12">
                            <label for="password_confirmation" class="fw-bold"><?php echo e(__('ui.confirm')); ?> password</label><br>
                            <input type="password" name="password_confirmation" class="form-control">
                        </div>

                        
                        <div class="col-12">
                            <button class="btn btn-warning text-dark fw-semibold" type="submit"><?php echo e(__('ui.nav-register')); ?></button>
                        </div>
                    </div>
                </form>
...
<?php endif; ?><?php /**PATH C:\Users\Anna\aulab-esercizi\ProgettoFinale\PRESTO.it_G-01\resources\views/auth/register.blade.php ENDPATH**/ ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-2  py-5">
                <h2 class="fw-bolder mt-5 text-center"><?php echo e(__('ui.search-by-category')); ?></h2>
                <div class="btn-group gx-5 d-flex justify-content-center">
                    <button class="btn btn-warning btn-lg dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <?php echo e(__('ui.bacheca-category')); ?>
                        ...
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                                <div class="text-center">
                                    ...
                                    <p class="lead fw-normal text-muted mb-5"><?php echo e(__('ui.bacheca-subtitle')); ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="row gx-5">
...
<?php endif; ?>
                                ...
                                <div class="col-12">
                                    <p class="h1 text-center"><?php echo e(__('ui.no-category')); ?></p>
...
<?php endif; ?><?php /**PATH C:\Users\Anna\aulab-esercizi\ProgettoFinale\PRESTO.it_G-01\resources\views/articles/index.blade.php ENDPATH**/ ?>